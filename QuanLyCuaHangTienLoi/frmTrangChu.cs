    ...
    public partial class frmTrangChu : Form
    {
        ...
        public void LoadUserControl(UserControl uc, bool xoa)
        {
            if (panelContent.Controls.Count > 0 && panelContent.Controls[0] == uc)
                return; // ?ã hi?n r?i, không làm gì c?
            if (xoa && panelContent.Controls.Count > 0)
            {
                var oldUC = panelContent.Controls[0];
                oldUC.Dispose(); // Gi?i phóng b? nh?
            }

            panelContent.Controls.Clear(); // Xóa n?i dung c?

            // Thi?t l?p UserControl ?? l?p ??y panel
            uc.Dock = DockStyle.Fill;
            uc.AutoScroll = true; // Cho phép cu?n n?u n?i dung l?n h?n
        ...
        private void frmTrangChu_Load(object sender, EventArgs e)
        {
            ...
            this.WindowState = FormWindowState.Maximized; // M? r?ng toàn màn hình

            // Set encoding for form
            this.Font = new Font("Segoe UI", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            this.SizeGripStyle = SizeGripStyle.Hide; // ?n d?u kéo giãn góc Form
            this.AutoSize = true;
            ...
            // t??ng tác s? ki?n trong module QuanLyDuLieu
            ...
            // t??ng tác s? ki?n trong module QuanLyHoaDon
            ...
            // t??ng tác s? ki?n trong module CaLamViec
