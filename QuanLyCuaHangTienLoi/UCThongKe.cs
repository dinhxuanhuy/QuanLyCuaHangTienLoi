...
namespace QuanLyCuaHangTienLoi
{
    public partial class UCThongKe : UserControl
    {
        ...
        private void btn_doanhThu_Click(object sender, EventArgs e)
        {
            ...
            UserControl ucCanChuyenToi = Program.ucThongKeDoanhThu;
        ...
        private void btn_chiPhi_Click(object sender, EventArgs e)
        {

            UserControl ucCanChuyenToi = Program.ucThongKeChiPhi;
            NavigateRequest?.Invoke(ucCanChuyenToi);
        }

        private void btn_loiNhuan_Click(object sender, EventArgs e)
        {
            UserControl ucCanChuyenToi = Program.ucThongKeLoiNhuan;
            NavigateRequest?.Invoke(ucCanChuyenToi);
        }
    }
}
